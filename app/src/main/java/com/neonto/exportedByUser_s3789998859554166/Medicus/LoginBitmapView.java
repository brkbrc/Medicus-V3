...
public class LoginBitmapView extends FrameLayout {
    ...
    public LoginBitmapView(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public LoginBitmapView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public LoginBitmapView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.login_bitmap);
