...
public class DetailsBackgroundShapeView extends View {



    public DetailsBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public DetailsBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public DetailsBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
