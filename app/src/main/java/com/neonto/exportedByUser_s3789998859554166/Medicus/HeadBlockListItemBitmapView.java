...
public class HeadBlockListItemBitmapView extends FrameLayout {
    ...
    public HeadBlockListItemBitmapView(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public HeadBlockListItemBitmapView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public HeadBlockListItemBitmapView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.head_block_list_item_bitmap);
