...
public class DetailsPictureView extends FrameLayout {
    ...
    public DetailsPictureView(Context context) {
        super(context);
        init(null, 0);
        createViews(context);
    }
    
    public DetailsPictureView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
        createViews(context);
    }
    
    public DetailsPictureView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createViews(Context context) {
        ...
        d = getResources().getDrawable(R.drawable.details_picture);
