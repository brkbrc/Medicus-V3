...
public class MedicusbersichtFragment extends Fragment {

    private MedicusbersichtBackgroundShapeView mBackgroundShape;
    private ListView mList;

    public MedicusbersichtFragment() {  // fragment must have a constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                Bundle savedInstanceState) {
        final View rootView = inflater.inflate(R.layout.fragment_medicusbersicht, container, false);
                
        mBackgroundShape = (MedicusbersichtBackgroundShapeView) rootView.findViewById(R.id.mBackgroundShape);
        mList = (ListView) rootView.findViewById(R.id.mList);
        final MedicusbersichtFragment fragment = this;

        final Context context = getActivity().getBaseContext();
        
        
        final MedicusbersichtListAdapter medicusbersichtListAdapter = new MedicusbersichtListAdapter(this);
        medicusbersichtListAdapter.setDataSheet(AppData.listDataDataSheet);
        mList.setAdapter(medicusbersichtListAdapter);
        
        AppData.listDataDataSheet.addListener(new DataSheet.OnChangeListener() {
           @Override
           public void dataSheetUpdated(DataSheet sheet) {
               medicusbersichtListAdapter.notifyDataSetChanged();
           }
        });

        
        getActivity().setTitle("Medicus - Übersicht");
    ...
    private void repositionElements() {
        ...
        layoutDescs_mList.add(new LayoutDesc(10, 0.0f, -148.0f, -25.0f, 720.0f, 1453.0f));  // 720*1280 px
        layoutDescs_mList.add(new LayoutDesc(2, 0.0f, -65.0f, -11.0f, 240.0f, 396.0f));  // 240*320 px
        layoutDescs_mList.add(new LayoutDesc(12, 0.0f, -142.0f, -32.0f, 1080.0f, 2094.0f));  // 1080*1920 px
        layoutDescs_mList.add(new LayoutDesc(8, 0.0f, -127.0f, -18.0f, 480.0f, 945.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
