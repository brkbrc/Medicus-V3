...
public class Screen4BackgroundShapeView extends View {



    public Screen4BackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public Screen4BackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public Screen4BackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.scale(m_realLayoutWidthInPx/1080.0f, m_realLayoutHeightInPx/1980.0f);
        canvas.translate(540.0f, 990.0f);
        path = new Path();
        path.moveTo(-540.0f, -990.0f);
          path.lineTo(540.0f, -990.0f);
        path.lineTo(540.0f, 990.0f);
        path.lineTo(-540.0f, 990.0f);
